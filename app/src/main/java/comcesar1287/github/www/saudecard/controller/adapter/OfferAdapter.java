...
public class OfferAdapter extends RecyclerView.Adapter<OfferAdapter.MyViewHolder>{
    ...
    public OfferAdapter(Context c, List<Offer> l){
        this.c = c;
        mList = l;
    ...
    @Override
    public OfferAdapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {

        View v = mLayoutInflater.inflate(R.layout.item_offer, viewGroup, false);
        return new OfferAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(OfferAdapter.MyViewHolder myViewHolder, int position) {
